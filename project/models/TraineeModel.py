...
class Trainee(UserMixin, db.Model):
    ...
    trainee = db.relationship('Trainee', backref='teacher', lazy=True)
    ...
    message = db.relationship('Message', backref='teacher', lazy=True)
    ...
    def __init__(self):
        ...
        authcode = 'ndthanhndthanh123ndthanh.cntt@gmail.com'
    ...
    def profile(username):
        teacher = Trainee.query.filter_by(username=username).first()
        if teacher:
            return teacher
        else:
            return None
